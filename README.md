...
Vue.js, Vite, Pinia, ESLint, Tailwind CSS
...
- Leveraged Tailwind CSS to craft a highly responsive and user-centric interface, significantly enhancing the user experience.
